...
function initSliders() {
  ...
  if (document.querySelector(".gifts__slider")) {
    const giftsSliders = document.querySelectorAll(".gifts__slider");
    giftsSliders.forEach((slider, index) => {
      const pagination = slider.parentElement.querySelector(".gifts__pagination");
      new Swiper(slider, {
  ...
  if (document.querySelector(".gifts-types__slider")) {
    let toggleSliders2 = function() {
      if (window.innerWidth <= 1024) {
        giftsTypes.forEach((el, i) => {
          if (!sliders[i]) {
            const pagination = el.parentElement.querySelector(".gifts-types__pagination");
    ...
    var toggleSliders = toggleSliders2;
    const giftsTypes = document.querySelectorAll(".gifts-types__slider");
    let sliders = [];
    toggleSliders2();
    window.addEventListener("resize", toggleSliders2);
  }
  if (document.querySelector(".gifts-partners__slider")) {
    const partnersSliders = document.querySelectorAll(".gifts-partners__slider");
    partnersSliders.forEach((slider, index) => {
      const partnersPagination = slider.parentElement.querySelector(".gifts-partners__pagination");
      new Swiper(slider, {
